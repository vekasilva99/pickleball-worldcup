...
export default function Hotel({ open, setOpen, team, setuser2 }) {
  ...
  const [option, setOptions] = useState(["10/20/2024", "10/21/2024", "10/22/2024"]);
  ...
  const [startDate, setStartDate] = useState("10/20/2024");
  const [endDate, setEndDate] = useState("10/29/2024");
  const [reservatedRooms, setReservatedRooms] = useState({ "10/20/2024": 0, "10/21/2024": 0, "10/22/2024": 0, "10/23/2024": 0, "10/24/2024": 0, "10/25/2024": 0, "10/26/2024": 0, "10/27/2024": 0, "10/28/2024": 0, "10/29/2024": 0 });

  const getReservations = async () => {
    const reservationAux = await getDocs(collection(db, "hotel"), where("payment_status", "==", true));
  ...
  return (
    <div className={open ? `flex justify-center dark register-form-container ${styles.open}` : `flex justify-center dark register-form-container ${styles.close}`}>
      {!showPayment && !otherOptions ? (
        <form className="register-form">
          <div className="form-title-container">
            <h2>Book Stay</h2>
            <button className="other-options" onClick={(e)=>{      e.preventDefault();setOtherOptions(true)}}>View Other Options</button>

          </div>
          <div className="form-container">
            <div className="space-y-12">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-base font-semibold leading-7 text-gray-900 form-title">Albergue Villa Deportiva Nacional (VIDENA)</h2>
                ...
                <h2 className="text-base font-semibold leading-7 text-gray-900 form-title">Availability</h2>
                ...
                <table class={`table-auto ${styles.table}`}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ paddingRight: "0.5rem" }}>
                        ...
                        >
                          ...
                          {availableRooms && <option value={2}>2</option>}
                    ...
                    <option value={4}>4</option>
                      ...
                      <td>
                        {rooms} {rooms == 1 ? "room" : "rooms"} for <br />
                        <span style={{ fontSize: "1rem", fontWeight: "bold" }}>${price}.00</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        {otherOptions ?
         ...
         <div className="form-title-container">
           <h2>Book Stay</h2>
           <button className="other-options" onClick={(e)=>{      e.preventDefault();setOtherOptions(false)}}>Go Back</button>
       ...
       <div className="hotel-container" >
        ...
        <div>
        <h2>Hotel Dazzler</h2>
        <h3>Address: Av. José Pardo N° 879, Miraflores, Lima, Perú</h3>
        <h3>Telephone: (511) 634 4001</h3>
        <h4>Web: <a onClick={()=>{window.open('https://www.dazzlermiraflores.com/')}}>www.dazzlermiraflores.com</a> </h4>
        <h4>Email: <a onClick={()=>{window.open('mailto:reservas@dazzlermiraflores.com')}}>reservas@dazzlermiraflores.com</a></h4>
        <h5>Executive in charge: Ian Galindo</h5>
        <h5>Phone: +51 936 842 823</h5>
        <h5>Distance of the venue: 35 - 40 min</h5>
        <h6>Corporate fees:</h6>
        <h5>•	Classic King:    $75.00
•	Classic Twin:   $80.00
•	Classic Triple: $95.00</h5>

</div>
<img src="/hotel/21.jpg"/>
       </div>
       <div className="hotel-container" >
  
  <div>
  <h2>Ibis Style San Isidro</h2>
  <h3>Address: Calle Micaela Bastidas N° 190, San Isidro, Lima</h3>
  <h4>Web: <a onClick={()=>{window.open('https://all.accor.com/hotel/B211/index.es.shtml')}}>https://all.accor.com/hotel/B211/index.es.shtml</a> </h4>
  <h4><a onClick={()=>{window.open('https://wa.link/mt4649')}}>Whatsapp</a></h4>
  <h5>Executive in charge: Ana Lucía Cáceres A.</h5>
  <h5>Distance of the venue: 15 – 25 min</h5>
  <h6>Corporate fees:</h6>
  <h5>•	Simple:  $55.00
•	Double:  $60.00
•	Superior:  $65.00</h5>
...
<img src="/hotel/22.jpg"/>
 </div>
 <div className="hotel-container" >
  
  <div>
  <h2>The Westin Lima Hotel & Convention Center</h2>
  <h3>Address: Amador Merino Reyna 551 - San Isidro, Lima 27 - Perú</h3>
  <h3>Telephone: (511) 712 7000</h3>
  <h4><a onClick={()=>{window.open('https://www.marriott.com/en-us/hotels/limwi-the-westin-lima-hotel-and-convention-center/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0')}}>Web</a> </h4>
  <h4>Email: <a onClick={()=>{window.open('mailto:jbruno@libertador.com.pe')}}>jbruno@libertador.com.pe</a></h4>
  <h5>Executive in charge: Josue Bruno</h5>
  <h5>Phone:  +51 934 962 715 </h5>

  <h5>Distance of the venue: 15 – 25 min</h5>
  <h6>Corporate fees:</h6>
  <h5>•	Deluxe Single:   $243.00
  •	Deluxe Double: $258.00
  •	Grand Deluxe Single:   $268.00
  •	Grand Deluxe Double: $283.00</h5>

</div>
<img src="/hotel/23.jpeg"/>
 </div>
         </div>
       </form>:
