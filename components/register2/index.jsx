...
import PaymentFormWrapper from "../PaymentForm3";
...
export default function Register({ open, setOpen, team, setuser2 }) {
  ...
  const [teamData, setTeamData] = useState({
    coach: { name: "", last_name: "",birthdate:null, email: "", phone: "", phone_code: "", dupr: null, passport: "", date_of_arrival: null, airline: "", flight_number: "", shirt_size: "" },
    captain: { name: "", last_name: "",birthdate:null, email: "", phone: "", phone_code: "", dupr: null, passport: "", date_of_arrival: null, airline: "", flight_number: "", shirt_size: "" },
    pairs: [{ name: "", last_name: "",birthdate:null, email: "", phone: "", phone_code: "", dupr: null, passport: "", date_of_arrival: null, airline: "", flight_number: "", shirt_size: "" }],
  });
  ...
  const validateInput = () => {
    ...
    if (!teamData.coach.name || !teamData.coach.last_name || !teamData.coach.email || !teamData.coach.phone || !teamData.coach.birthdate) {
      alert("Coach information is incomplete. Please fill in all fields.");
      return false;
    }

    if (!teamData.captain.name || !teamData.captain.last_name || !teamData.captain.email || !teamData.captain.phone || !teamData.captain.birthdate) {
      alert("Captain information is incomplete. Please fill in all fields.");
      return false;
    }
    ...
    for (let i = 0; i < teamData.pairs.length; i++) {
      ...
      if (!pair.name || !pair.last_name || !pair.email || !pair.phone || !pair.birthdate) {
    ...
    if (!emailRegex.test(teamData.captain.email)) {
      alert("Captain email is not in a valid format.");
      return false;
    }
  ...
  const addPair = (e) => {
    ...
    if (teamData.pairs.length <= 7) {
      setTeamData((prevTeamData) => ({
        ...prevTeamData,
        pairs: [...prevTeamData.pairs, { name: "", last_name: "",birthdate:null, email: "", phone: "", phone_code: "", dupr: null, passport: "", date_of_arrival: null, airline: "", flight_number: "", shirt_size: "" }],
      }));
    }
  };
  ...
  const registerTeamMember = async (newTeamRef, memberData, role, countryRef) => {
    try {
      ...
      sendEmail(memberData.email, password, user.name + " " + user.last_name, user.country.name, `https://www.copamundialdepickleball.com/${newUserRef.id}/senior/${newTeamRef.id}`);
    ...
    <div className={open ? `flex justify-center dark register-form-container ${styles.open}` : `flex justify-center dark register-form-container ${styles.close}`}>
      {!showPayment ? (
        <form className="register-form">
          <div className="form-title-container senior">
            <h2>Create Team</h2>
          </div>
          <div className="form-container senior">
            <div className="space-y-12">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-base font-semibold leading-7 text-gray-900 form-title">Coach Information</h2>
                <p className="mt-1 text-sm leading-6 text-gray-600 form-subtitle">Use an email address where they can receive their login information.</p>
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <div className="mt-2">
                      <select
                        ...
                        onChange={(e) => handleInputChange("coach", null, "phone_code", e.target.value)}
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <select id="coach-shirt-size" name="coach-shirt-size" type="text" value={teamData.coach.shirt_size} onChange={(e) => handleInputChange("coach", null, "shirt_size", e.target.value)} placeholder="Enter shirt size" className="block w-full rounded-md sm:text-sm sm:leading-6 input">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input id="coach-passport" name="coach-passport" type="text" value={teamData.coach.passport} onChange={(e) => handleInputChange("coach", null, "passport", e.target.value)} placeholder="Enter passport number" className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                    </div>
                  </div>
                  <div className="sm:col-span-3">
                    <label htmlFor="coach-dupr" className="block text-sm font-medium leading-6 text-gray-900 form-title">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <div className="mt-2">
                      <select
                        ...
                        onChange={(e) => handleInputChange("captain", null, "phone_code", e.target.value)}
                        placeholder="Enter phone number"
                        className="block w-full rounded-md sm:text-sm sm:leading-6 input"
                      >
                        {countryCodes.map((phone) => {
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input id="captain-airline" name="captain-airline" type="text" value={teamData.captain.airline} onChange={(e) => handleInputChange("captain", null, "airline", e.target.value)} placeholder="Enter airline" className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                    </div>
                  </div>
                  <div className="sm:col-span-3">
                    <label htmlFor="captain-dupr" className="block text-sm font-medium leading-6 text-gray-900 form-title">
                  ...
                  <div key={index} className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mt-10">
                    ...
                    {teamData.pairs.length > 1 && (
                      <h2
                        ...
                        style={{ textAlign: "center", color: "#EFB810", cursor: "pointer", borderColor: "#EFB810", width: "max-content" }}
        ...
        >
          +  Add Pair
                    ...
                    <h2
                      ...
                      style={{ textAlign: "center", color: "#000", cursor: "pointer", borderColor: "#cccccc", backgroundColor: "#cccccc" }}
