  ...
  try {
    ...
    const info = await transporter.sendMail({
      ...
      <html>
        ...
        <body>
          <div class="container">
          <img style=" width:100%;display:flex;align-items:center;border-radius: 1rem;height:auto;" class="banner" src="https://firebasestorage.googleapis.com/v0/b/pickleball-worldcup.appspot.com/o/2403%20World%20Cup%20-%20mailing%20TEAM%20CORDINATOR-03.png?alt=media&token=e8c39db1-8a33-4b62-8da0-896ef9dcae31" />
   <div style="width:100%; text-align:left;margin-top:20px;">
         <p>Dear ${coordinator},</p>
            <p>We are excited to extend our congratulations on your selection as the Senior Team Coordinator for your delegation.</p>
