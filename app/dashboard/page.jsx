                    ...
                    <div className="space-y-12">
                        ...
                        {edit ? (
                          ...
                          <div className="accordion-button-container">
                            <h2 className="text-base font-semibold leading-7 text-gray-900 form-title">
                              Coordinator -{" "}
                              <span style={{ color: "#EFB810", fontStyle: "italic" }}>
                        ...
                        {edit ? (
                          ...
                          <div className={` ${showCoordinator ? "mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 show" : "no-show"}`}>
                            ...
                            <div className="sm:col-span-3">
                              ...
                              <div className="mt-2">
                                <input disabled={true} id="coordinator-dupr" name="coordinator-dupr" type="number" step={"0.1"} min={"2.5"} max={"5.4"} value={teamData.coordinator.dupr} className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                              </div>
                            </div>
                            <div className="sm:col-span-3">
                              <label htmlFor="coordinator-dupr" className="block text-sm font-medium leading-6 text-gray-900 form-title">
                        ...
                        {edit ? (
                          ...
                          <div className={` ${showCoach ? "mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 show" : "no-show"}`}>
                            ...
                            <div className="sm:col-span-3">
                              ...
                              <div className="mt-2">
                                <input disabled={true} id="coach-dupr" name="coach-dupr" type="number" step={"0.1"} min={"2.5"} max={"5.4"} value={teamData.coach?.dupr} className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                              </div>
                            </div>
                            <div className="sm:col-span-3">
                              <label htmlFor="coach-dupr" className="block text-sm font-medium leading-6 text-gray-900 form-title">
                        ...
                        {edit ? (
                          ...
                          <div className={` ${showCaptain ? "mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 show" : "no-show"}`}>
                            ...
                            <div className="sm:col-span-3">
                              ...
                              <div className="mt-2">
                                <input disabled={true} id="captain-dupr" name="captain-dupr" type="number" step={"0.1"} min={"2.5"} max={"5.4"} value={teamData.captain.dupr} className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                              </div>
                            </div>
                            <div className="sm:col-span-3">
                              <label htmlFor="captain-dupr" className="block text-sm font-medium leading-6 text-gray-900 form-title">
                      ...
                      <div className={`border-b border-gray-900/10 pb-12 ${edit ? "" : "accordion"}`}>
                        {edit ? (
                          ...
                          <h2 className="text-base font-semibold leading-7 text-gray-900 form-title">
                            <span style={{ color: "#EFB810", fontWeight: "bold", textTransform: "uppercase" }}>
                              {" "}
                            ...
                            !edit && ( // Remove the curly braces here
                              <div key={index} className={`grid grid-cols-1 gap-x-6 sm:grid-cols-6 mt-10" ${edit ? "" : "accordion"}`}>
                                ...
                                <div className={`sm:col-span-3 ${showPairs[index] ? "show" : "no-show"}`}>
                                  ...
                                  <div className="mt-2">
                                    <input disabled={true} id={`pair-phone-${index}`} name={`pair-phone-${index}`} type="number" step={"0.1"} min={"2.5"} max={"5.4"} value={teamData.pairs[index]?.dupr} className="block w-full rounded-md sm:text-sm sm:leading-6 input" />
                                  </div>
                                </div>
                                <div className={`sm:col-span-3 ${showPairs[index] ? "show" : "no-show"}`}>
                                  <label htmlFor={`pair-shirt-size-${index}`} className="block text-sm font-medium leading-6 text-gray-900 form-title">
                ...
                <div className="column-45-2">
                  <div className="option-dashboard">
                    ...
                    <div className="content">
                      <h2>Hotel</h2>
                      {user2.team?.reservation && <h4> Albergue Villa Deportiva Nacional (VIDENA)</h4>}
                        ...
                        <>
                          {user2.team?.reservation.map((reservation) => {
                            return (
                              <div>
                                <h3>
                                  {reservation.rooms} {reservation.rooms == 2 ? "rooms" : "room"} ({reservation.rooms * 4} people)
                                </h3>

                                <h3>
                                  {format(new Date(reservation.start_date.seconds * 1000), "MM/dd/yyyy")} - {format(new Date(reservation.end_date.seconds * 1000), "MM/dd/yyyy")}
                                </h3>
                              </div>
                            );
                          })}
                  ...
                  <div className="option-dashboard option-column">
                    <LazyImage src="/III-TOURNAMENT-flyer-RESIZED-1920x970.png" width={200} height={200} className="option-image" />

                    <div className="content">
                      <h2>PRIOR TO THE WORLD CUP</h2>

                      <h4>Live the international Pickleball competition in the III Official Pickleball Peru Tournament - International Edition.</h4>

                      <div className="button-container">
                        <button
                          onClick={() => {
                            window.open("https://pickleballbrackets.com/ptd.aspx?eid=2e6c8812-a002-4f38-b280-fcef63d32c0f");
                          }}
                        >
                          Learn More
                        </button>
